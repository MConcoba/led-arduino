...
import 'package:hcled/widgets/action_button.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget _controlBT() {
    return SwitchListTile(
      ...
      title:
          Text(_bluetoothState ? 'Bluetooth encendido' : 'Bluethoot apagado'),
    );
  }
  ...
  Widget _infoDevice() {
    return ListTile(
      ...
      title: Text('Conecatdo a: ${_deviceConnected?.name ?? 'ninguno'}'),
